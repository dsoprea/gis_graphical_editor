...
def test_parse_slider_endpoint_timestamp_parses_utc_suffix():
  parsed_timestamp = gis_graphical_editor.time_slider_panel.parse_slider_endpoint_timestamp(
    "2024-06-01 08:00:00 UTC",
    None,
  )

  assert parsed_timestamp == datetime.datetime(2024, 6, 1, 8, 0, 0, tzinfo=datetime.timezone.utc)


def test_parse_slider_endpoint_timestamp_parses_numeric_offset_suffix():
  mountain_timezone = datetime.timezone(datetime.timedelta(hours=-6))
  parsed_timestamp = gis_graphical_editor.time_slider_panel.parse_slider_endpoint_timestamp(
    "2024-06-01 08:00:00 UTC-06:00",
    mountain_timezone,
  )

  assert parsed_timestamp == datetime.datetime(2024, 6, 1, 8, 0, 0, tzinfo=mountain_timezone)


def test_parse_slider_endpoint_timestamp_uses_reference_timezone_when_suffix_missing():
  mountain_timezone = datetime.timezone(datetime.timedelta(hours=-6))
  parsed_timestamp = gis_graphical_editor.time_slider_panel.parse_slider_endpoint_timestamp(
    "2024-06-01 08:00:00",
    mountain_timezone,
...
def test_parse_slider_endpoint_timestamp_returns_none_for_invalid_text():
  parsed_timestamp = gis_graphical_editor.time_slider_panel.parse_slider_endpoint_timestamp(
    "not-a-timestamp",
...
def test_parse_current_slider_position_text_strips_point_position_suffix():
  parsed_timestamp = gis_graphical_editor.time_slider_panel.parse_current_slider_position_text(
    "2024-06-01 08:00:00 UTC (3 of 5)",
    None,
  )
